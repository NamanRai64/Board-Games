...
function App() {
  ...
  const games = [
    ...
    { id: 'missionaries', name: 'River Crossing', desc: 'Solve the Missionaries & Cannibals river puzzle using state-space search.', img: '/assets/wumpus.png', component: <Missionaries /> },
